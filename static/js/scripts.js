angular.module('project', ['projectApi']).
  config(function($routeProvider) {
    $routeProvider.
      when('/', {controller:ListCtrl, templateUrl:BASE_URL+'home/template_list'}).
      when('/edit/:id', {controller:EditCtrl, templateUrl:BASE_URL+'home/template_detail'}).
      when('/new', {controller:CreateCtrl, templateUrl:BASE_URL+'home/template_detail'}).
...
angular.module('projectApi', ['ngResource']).
  factory('Project', function($resource) {
    var Project = $resource(BASE_URL+'api/home/:method/:id', {}, {
...
//         Project.save({id: this.id},
//           angular.extend({}, this, {id:undefined}), cb);
//       };
//
//       this.destroy = function(cb) {
//         Project.remove({id: this.id}, cb);
//       };
//
