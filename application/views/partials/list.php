...
<table class="table table-hover">
  ...
  <tr>
    ...
    <th class="span2"><a class="btn btn-success btn-small pull-right" href="<?php echo site_url('home#/new'); ?>"><i class="icon-plus icon-white"></i> Add project</a></th>
  </tr>
  </thead>
  <tbody>
  <tr ng-repeat="project in projects | filter:search | orderBy:'name'">
    ...
    <td>
      <div class="pull-right">
        <a class="btn btn-primary btn-mini" href="<?php echo site_url('home#/edit/{{project.id}}'); ?>"><i class="icon-edit icon-white"></i> Edit</a>
